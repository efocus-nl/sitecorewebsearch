...
{
    class HtmlDocumentProcessor : NCrawler.HtmlProcessor.HtmlDocumentProcessor
    {
        #region Constructors
        ...
        public HtmlDocumentProcessor(IDictionary<IEnumerable<char>, IEnumerable<char>> filterTextRules, IDictionary<IEnumerable<char>, IEnumerable<char>> filterLinksRules)
            : base((Dictionary<IEnumerable<char>, IEnumerable<char>>)filterTextRules, (Dictionary<IEnumerable<char>, IEnumerable<char>>)filterLinksRules)
        {
        }
        ...
        protected override string NormalizeLink(string baseUrl, string link)
        {

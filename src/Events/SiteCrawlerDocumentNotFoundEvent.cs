...
{
    public class SiteCrawlerDocumentNotFoundEvent : BaseEvent
    {
        public override void Publish(params object[] arguments)
        {
            ...
            Event.RaiseEvent("SiteCrawler:DocumentNotFound", new CrawlDocumentErrorEventArgs(updateCrawler, id, propertyBag));
